            ...
            >
              <CardContent className="flex flex-col items-center gap-4 lg:gap-6 p-0 text-center">
                ...
                <div className="flex flex-col items-center gap-3 lg:gap-4 relative self-stretch w-full">
                  <h4 className="mt-[-1.00px] font-heading-h4 font-[number:var(--heading-h4-font-weight)] text-[length:var(--heading-h4-font-size)] text-center tracking-[var(--heading-h4-letter-spacing)] leading-[var(--heading-h4-line-height)] relative self-stretch text-[#01010a] [font-style:var(--heading-h4-font-style)] text-balance">
                    {value.title}
                  </h4>
